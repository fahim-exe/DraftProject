...
namespace DraftProject
{
    public partial class Form5 : Form
    {
        ...
        string step_4 = @"/chair_step_4.txt";
        ...
        {
            string chair_name, comments, explain = "", date;
            string check = "";
            ...
            chair_name = textBox1.Text;
            date = dateTimePicker1.Text;

            if (check == "Yes")
            {
                myDict["Chair Name"] = chair_name;
        ...
        {
            string s4 = path + step_4;

            using (StreamWriter sw = new StreamWriter(s4, false))
            {
                foreach (KeyValuePair<string, string> entry in myDict)
                {
            ...
            try
            {
                ...
                (this.Owner as Form1).btn4.Enabled = false;
                this.Hide();
            }
